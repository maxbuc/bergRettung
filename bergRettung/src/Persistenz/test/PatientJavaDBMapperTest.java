...
public class PatientJavaDBMapperTest{
    ...
    public void insertPatient(Patient p){
        ...
        try {
            ...
            Logger.getLogger(PatientJavaDBMapperTest.class.getName()).log(Level.SEVERE, null, ex);
            try {
                conn.rollback();
            } catch (SQLException ex1) {
                Logger.getLogger(PatientJavaDBMapperTest.class.getName()).log(Level.SEVERE, null, ex1);
            }
        }
